...
<body>
          ...
          <form action="playerRegistration.php" method="post" role="form">
            <div class="row">
              ...
              <table id="form-table" class="table table-striped">
                ...
                <tbody id="table-body">
                  <tr>
                    ...
                    <td><input class="col-xs-12" type="text" name="team_leader_01" value="" placeholder=" "></td>
                  </tr>
                  <tr>
              ...
              <table id="form-table" class="table table-striped">
                ...
                <tbody id="table-body">
                  <tr>
                    <td><input class="col-xs-12" type="text" name="degree_01" value="" placeholder=" "></td>
                    <td><input class="col-xs-12" type="text" name="ins_dept_01" value="" placeholder=" "></td>
                    <td><input class="col-xs-12" type="text" name="board_uni_01" value="" placeholder=" "></td>
                    <td><input class="col-xs-12" type="text" name="pass_year_01" value="" placeholder=" "></td>
                    <td><input class="col-xs-12" type="text" name="result_01" value="" placeholder=" "></td>
                  </tr>
                  <tr>
  ...
  <div class="copyright">
    <p>©2025 | All right reserved by Aakash</p>
  </div>
